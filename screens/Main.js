        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.categoryContainer}>
                    <TouchableOpacity style={this.state.selected=="regular" ? styles.categoryBoxSelected : styles.categoryBoxSelected}
                    onPress={()=>{this.setState({selected:"regular"})}}
                    >
                        <Text>Regular</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={this.state.selected=="round" ? styles.categoryBoxSelected : styles.categoryBoxSelected}
                           onPress={()=>{this.setState({selected:"round"})}}
                    >
                        <Text>Round</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={this.state.selected=="rimless" ? styles.categoryBoxSelected : styles.categoryBoxSelected}
                           onPress={()=>{this.setState({selected:"rimless"})}}
                    >
                        <Text>Rimless</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={this.state.selected=="aviator" ? styles.categoryBoxSelected : styles.categoryBoxSelected}
                           onPress={()=>{this.setState({selected:"aviator"})}}
                    >
                        <Text>Aviator</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={this.state.selected=="wayfarer" ? styles.categoryBoxSelected : styles.categoryBoxSelected}
